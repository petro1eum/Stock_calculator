...
const InventoryOptionCalculator = () => {
  ...
  const [abcAnalysisResult, setAbcAnalysisResult] = useState([]);
  ...
  function mcDemandLoss(units, muWeek, sigmaWeek, weeks, trials = 1000) {
  ...
  const SliderWithValue = ({ label, value, onChange, min, max, step, tooltip, unit = "" }) => {
            ...
            <div className="h-80">
              <ResponsiveContainer width="100%" height="100%">
                <LineChart data={series} margin={{ top: 5, right: 30, left: 20, bottom: 5 }}>
                  ...
                  />
                  <Tooltip
                    formatter={(value) => ['$' + fmt(value), 'Чистый эффект']}
