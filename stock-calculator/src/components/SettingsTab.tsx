    ...
    <div className="bg-white rounded-lg shadow-md p-4">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
        ...
        <SliderWithValue 
          ...
          step={100} 
          unit="штук"
          tooltip="Верхний предел оптимизации, если у товара не задан свой лимит хранения. Также задает масштаб графиков анализа товара."
        />
        ...
        <SliderWithValue 
          ...
          step={0.5} 
          unit="%/год"
          tooltip="ВОПРОС: Если бы вы НЕ вложили деньги в товар, а вложили их куда-то еще (банковский депозит, другой бизнес, акции), сколько бы заработали за год? В модели эта ставка применяется через дисконтирование Black-Scholes, а не добавляется прямой надбавкой к закупочной цене."
        />
        ...
        <SliderWithValue 
          ...
          tooltip="ВОПРОС: Сколько денег вы тратите, чтобы хранить 1 единицу товара на складе 1 неделю? КАК СЧИТАТЬ: 1) Возьмите все затраты на склад за месяц (аренда + зарплаты + охрана + свет), 2) Поделите на количество товаров на складе, 3) Поделите на 4 недели."
        />
        ...
        <SliderWithValue 
          ...
          step={0.1} 
          unit="₽/шт"
          tooltip="СИТУАЦИЯ: Товар кончился, вы звоните поставщику: 'Привези СРОЧНО!'. Он говорит: 'Могу, но дороже'. ВОПРОС: на сколько меньше вы заработаете с каждой штуки при срочной закупке."
        />
      ...
      <div className="mt-6 space-y-4">
        ...
        <div className="p-4 bg-green-50 border-l-4 border-green-500">
          ...
          <div className="text-sm text-green-900 space-y-1">
            ...
            <p>• <strong>Хранение:</strong> 10-50 ₽ (мелкие товары), 100-300 ₽ (обычные), 500 ₽+ (холодильники, мебель)</p>
            <p>• <strong>Экстренные закупки:</strong> 0-30% (импорт), 50-80% (город рядом), 90%+ (свое производство)</p>
            <p>• <strong>Потери при срочности:</strong> 100-200 ₽ (мелкая маржа), 500-1000 ₽ (обычно), 2000 ₽+ (дорогие товары)</p>
