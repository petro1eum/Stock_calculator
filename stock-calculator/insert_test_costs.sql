...
BEGIN
    ...
    VALUES 
        (target_user_id, today_date, '202342304', 21, 'CNY', 0.98, 'USD', 13.0),
        (target_user_id, today_date, '364594869', 25, 'CNY', NULL, NULL, 13.0),
        (target_user_id, today_date, '247956069', 26, 'CNY', NULL, NULL, 13.0),
